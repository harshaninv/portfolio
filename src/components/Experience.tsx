...
const jobs = [
  ...
  },
  {
    ...
    stack: "Laravel · React.js · MySQL · Postman",
    bullets: [
      "Assisted in developing web application features using Laravel and React.js during the internship period.",
  ...
  {
    company: "Freelance",
    fullName: "Independent Projects",
    role: "Full Stack Developer",
    range: "2022 — 2024",
    stack: "Flutter · Node.js · MongoDB · React.js · Laravel",
    bullets: [
      "Built the List-Me smart grocery shopping app using Flutter, Node.js, and MongoDB.",
      "Developed a personal library management system (Bookstore) with React and Laravel.",
      "Created Health Direct — a healthcare mobile app concept starting with Figma wireframes through to a React implementation, designed for the Hackholics competition.",
